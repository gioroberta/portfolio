# Projeto Portfólio Pessoal - Giovanna Roberta
...
O Projeto Portfólio Pessoal é um site profissional moderno desenvolvido por **Giovanna Roberta**, utilizando **HTML, CSS e JavaScript**, com o objetivo de apresentar meu perfil como desenvolvedora, meus projetos e formas de contato de maneira clara, organizada e responsiva.

O projeto consome dados dinâmicos da **API do GitHub** para carregar automaticamente informações do meu perfil e repositórios, garantindo que o portfólio permaneça sempre atualizado.
...
1. Clone o repositório:
   ...
   ```bash
   git clone https://github.com/gioroberta/portfolio
   ```
...
🔗 https://github.com/gioroberta/portfolio
